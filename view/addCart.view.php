...
<body>
    ...
    <?php 
        ...
        echo '<form action=addCart.php method=POST>
                    <input id="originalid" type=hidden name="valueAddCart" value="' . htmlspecialchars($row['ID']).'">
                    <input id="originalPrice" type=hidden name="price" value="' . htmlspecialchars($row['price']) .'">
